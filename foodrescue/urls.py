...
urlpatterns = [
    ...
    path("organisation-inventory/filter/",views.filter_inventory,name="filter_inventory"),
    path("create-event/filter-inventory/",views.filter_event_inventory,name="filter_event_inventory"),
    path("organisation_inventory/<int:reservation_id>/details/",views.inventory_food_detail,name="inventory_food_detail"),
    path("events/<int:event_id>/",views.event_detail,name="event_detail"),
    path("food-listings/<int:listing_id>/details/",views.food_listing_detail,name="food_listing_detail"),
    path("inventory/<int:reservation_id>/update-quantity/",views.update_inventory_quantity,name="update_inventory_quantity"),
    ...
    path("reservations/<int:reservation_id>/organisation-complete/",views.organisation_mark_pickup_completed,name="organisation_mark_pickup_completed"),
    path("reservations/<int:reservation_id>/establishment-complete/",views.establishment_mark_pickup_completed,name="establishment_mark_pickup_completed"),
    path("logout/", views.logout_view, name="logout"),
    path("establishment/profile/",views.establishment_profile,name="establishment_profile"),
    path("establishment/food-listings/",views.establishment_food_listings,name="establishment_food_listings"),
    path("establishment/food-listings/<int:listing_id>/",views.establishment_food_listing_detail,name="establishment_food_listing_detail"),
    ...
    path("establishment/completed-pickups/",views.establishment_completed_pickups,name="establishment_completed_pickups"),
]
